...
<body class="bg-fixed bg-cover bg-center text-[#3c2f2f] flex flex-col min-h-screen"
    ...
    <!-- Footer (same format as Mood Board page) -->
    <footer class="w-full py-8 text-center bg-[#8B7E74] text-white mt-auto">
        <p class="text-lg">
            &copy;
            <script>
        ...
        <p class="mt-2 text-[#f0e9e3] text-sm">A haven for book lovers</p>
    </footer>

...
<body class="bg-white text-[#3c2f2f] flex flex-col min-h-screen">
    <!-- Page content container -->
    <div class="flex-grow px-20 py-10 max-w-[1200px] mx-auto w-full">
        ...
        <section class="text-center mb-16">
            ...
            <?= view('components/buttons/darkmode_buttons.php') ?>
        </section>
